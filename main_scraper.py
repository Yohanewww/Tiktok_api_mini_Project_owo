...
class Scraper:
    ...
    async def get_douyin_video_id(self, original_url: str) -> Union[str, None]:
        ...
        try:
            ...
            # 发现页 https://www.douyin.com/discover?modal_id=7086770907674348841
                ...
                video_id = re.findall('modal_id=(\d+)', video_url)[0]
    ...
    async def link_parse(self, video_url:str) -> dict:
        ...
        video_id = await self.get_douyin_video_id(video_url) 
        if video_id:
            print('getting video data')
            data = await self.get_douyin_video_data(video_id)
            ...
            if data:
                ...
                try:
                    ...
                    print("nvm_url:", nwm_video_url_HQ)
                    # 更新数据/Update data
    ...
    @staticmethod              
    def hybird_parsing_minimal(self, data: dict):
